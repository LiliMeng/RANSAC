...
int main()
{
    ...
    // ofstream fout("/home/lili/PatternRecognition/RANSAC/chess_inliers_result/estimated_poses_error980.txt");
     ...
     //ofstream fout3("/home/lili/PatternRecognition/RANSAC/chess_inliers_result/inliers_tran_rot_error_200images.txt"); //for chess
    //for heads
    ofstream fout3("/home/lili/PatternRecognition/RANSAC/heads_inliers_result/inliers_tran_rot_error_1000heads.txt");
    ...
    */
    ...
    //const char* leaf_file_dir="/home/lili/PatternRecognition/chess_prediction_result/predict_result/*.txt"; //for chess
     const char* leaf_file_dir="/home/lili/PatternRecognition/RANSAC/heads/pred_3dLoc/*.txt"; // for heads
    ...
    for(int m=0; m<num_imgs; m++)
    {
       ...
       // cout<<"camera_pose_file_jimmy "<<camera_pose_file_jimmy<<endl;
        ...
        cout<<"current frame number is "<<frame_num<<endl;
    ...
    for(int i=0; i<iteration_num; i++)
    {
       ...
       bool is_solvedPnP=cv::solvePnP(Mat(four_wld_pts), Mat(four_img_pts), camera_matrix, Mat(), rvec, tvec, false, CV_P3P);
       cout<<"is_solvedPnP"<<is_solvedPnP<<endl;
       if(!is_solvedPnP)
       {
            continue;
       }
    ...
    cout<<"camera_pose is "<<camera_pose<<endl;
    cout<<"gt_pose is "<<gt_pose<<endl;
...
//    fout<<error_trans<<" "<<error_rot<<endl;
   ...
   // cout<<"max_inliers_position "<<max_inliers_position<<"max_liers_num "<<max_inliers_num<<" inlier number percentage(reprojection_error<10) is "<<1.0*max_inliers_num/img_pts.size()<<endl;
    ...
    cout<<frame_num<<" "<<max_inliers_num<<" "<<trans_error_at_max_inliers<<" "<<rot_error_at_max_inliers<<endl;
